# Проект: Mesto: валидация форм и инфраструктура (Третий месяц)
...
Разработана валидация всех форм. Улучшено UX при работе с попапами (закрытие попапа кликом на оверлей, закрытие попапа нажатием на Esc). 
Создадано инфраструктурное окружение с помощью Webpack.
